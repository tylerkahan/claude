    ...
    <div style={{ display: 'flex', minHeight: '100vh', background: '#03040d' }}>
      ...
      <div style={{ flex: 1, padding: '40px', overflowY: 'auto' }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '32px' }}>
          <div>
            <h1 style={{ fontFamily: "'Space Grotesk',sans-serif", fontSize: '28px', fontWeight: 800, color: '#fff' }}>Digital Assets</h1>
            <p style={{ color: '#6b7ab8', fontSize: '14px', marginTop: '4px' }}>Manage your crypto, online accounts, and digital footprint</p>
          </div>
